...
![看图说话演示](images/59d421891f813b0d3c0cbe12574b6a72_720.jpg)
...
配置方式和 TTS 完全对称——`provider` 指定服务商，`apiKey` 和 `baseUrl` 会自动从 `models.providers` 继承，支持任何 OpenAI 兼容的 STT 接口。
